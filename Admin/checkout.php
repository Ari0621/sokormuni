          ...
          <div class="content-wrapper">
            <div class="row ">
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <a href="" class="mdi mdi-library-plus btn-primary btn-lg"> <span class="ml-1"> Add New Checkout </span></a>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <div class="badge">Total Items</div>
                            </td>
                            <td>
                              <div class="created at">User ID</div>
                            </td>
                            <td>
                              <div class="created at d-flex align-items-center">
                                <div class="form-check form-check-inline">
                                  <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1">
                                  <label class="form-check-lab" for="inlineRadio1">Verifikasi</label>
                                </div>
                                <div class="form-check form-check-inline">
                                  <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option1">
                                  <label class="form-check-lab" for="inlineRadio2">Dikemas</label>
                                </div>
                                <div class="form-check form-check-inline">
                                  <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio3" value="option1">
                                  <label class="form-check-lab" for="inlineRadio3">Kirim</label>
                                </div>
