    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            <tr>
                ...
                <td><?php echo "<td><a href='./../../controller/controller_produk/materials/edit_materials.php?id=$row[id]'>Edit</a> | <a href='./../../controller/controller_produk/materials/delete_materials.php?id=$row[id]'>Delete</a></td></tr>";?></td>
            </tr>
            <?php 
            }
    }else{
