...
<head>
    ...
    <title>Sokormuni.Id | Polos Eksklusif</title>
...
<body class="bg-pattern">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top main-header">
    ...
    <!--Slider-->
        ...
        <div class="slider">
            <div><img style="width: 100%;" src="images/header1.png" alt=""></div>
            <div><img style="width: 100%;" src="images/header2.png" alt=""></div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center fs-30 f-bold mb-4">
                ...
                <div class="card mb-3 b-1">
                    <div class="card-body p-0 ">
                        ...
                        <div class="px-3 py-2 mx-auto">
                            <div class="mt-1 mb-0 f-bold">
                                <a href='details.php?id=<?php echo $row["product_id"]; ?>' class="" > <?php echo $row['product_name'];?></a>
                            </div>
                            <div class="mb-4">
                                <p>Size : S M L XL</p>
                            </div>
                            <div>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <p class="mb-0">Rp.<?php echo number_format ($row['products_harga']);?></p>
                                    </div>
                                    <div>
                                        <a href='beli.php?id=<?php echo $row["product_id"]; ?>'  class="btn btn-color"> <i class="fa fa-shopping-cart fs-15" aria-hidden="true"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
