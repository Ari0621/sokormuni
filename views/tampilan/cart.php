...
<body class="bg-pattern">
                                ...
                                <div class="col-md-5 col-lg-3 col-xl-3">
                                    <div class="view zoom overlay z-depth-1 rounded mb-3 mb-md-0">
                                        <img class="img-fluid w-100"
                                            src=<?php echo "./../../Image/".$product['products_image1'];?>
                                            alt="Sample">
                                    </div>
                                </div>
                                    ...
                                    <div>
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                ...
                                                <p class="mb-2 text-muted text-uppercase small">Color: <?php echo $product['product_color'];?></p>
                                            ...
                                            <div>
                                                <div class="def-number-input number-input safari_only mb-0 w-100 d-flex align-items-center">
                                                    ...
                                                    <input class="quantity" min="0" name="quantity" value="<?php echo $jumlah;?>"
                                                        type="number">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <a href="hapus_cart.php?id=<?php echo $product["product_id"]; ?>" type="button"class="card-link-secondary small  text-uppercase mr-3 title-cart"><i class="fas fa-trash-alt mr-1 "></i> Remove item
                                                </a>
                                            </div>
                                            <p class="mb-0 f-bold">Rp.<?php echo number_format ($supharga);?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    ?>
                ...
                <div class="col-12 text-right f-bold">
                    <p>Subtotal: Rp.<?php echo number_format ($totalharga);?></p>
                </div>
 
                <!--tombol lanjutan-->
                <div class="col-12 text-center">
                    <a href='index.php' class="btn btn-color text-left mr-2">Lanjut Belanja</a>
                    <a href='checkout.php' class="btn btn-color text-left mr-2">Proses ke Checkout</a>
                </div>
            </div>
        </div>      
    </div>
